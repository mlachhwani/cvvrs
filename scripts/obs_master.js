/* =============================================================================
   obs_master.js — FULL OBSERVATION MASTER (LOCKED)
   Used by obs_ui.js / submit.js / pdf_engine.js
============================================================================= */

console.log("obs_master.js loaded");

/* TYPES:
   YESNO, YESNO_DAY, RATING
   DEFAULTS:
   YES/NO/DAY TIME for YesNo types
   VERY GOOD for Ratings unless specified
============================================================================= */
...
window.OBS_MASTER = [
  ...
  { id: 14, sec:2, role:"ALP", title:"Standing & Holding RS while approaching Danger Signal", type:"YESNO", def:"YES" },
...
console.log("OBS_MASTER count:", OBS_MASTER.length);
